...
public class SMSUtils {
	...
	public static boolean sendShortMessage(String templateCode,String phoneNumbers,String param) throws ClientException{
		...
		// 替换成你的AK
        final String accessKeyId = "LTAI4FvkJVB3VqJgpDWRYrFW";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "Dezen5kL0vJykIHSGHtpWvcVKfACdO";// 你的accessKeySecret，参考本文档步骤2
