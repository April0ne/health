...
public class Order implements Serializable{
    ...
    public Order(Integer member_id, Date orderDate, String orderType, String orderStatus, Integer setmealId) {
    ...
    public Order(Integer id, Integer member_id, Date orderDate, String orderType, String orderStatus, Integer setmealId) {
        this.id = id;
        this.member_id = member_id;
        this.orderDate = orderDate;
        this.orderType = orderType;
